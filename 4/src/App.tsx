...
function App() {
  ...
  const studentData = {
    ...
    skills: [
      ...
      { name: "REST APIs & Middleware", category: "Backend & Systems", level: "Advanced", percentage: 90 },
      ...
      { name: "Postman / API Testing", category: "Tools & Design", level: "Advanced", percentage: 85 },
